...
_KNOWN_AUDIT_ACTIONS: tuple[str, ...] = (
    ...
    "auth.denied",
    "auth.status_polled",
    "auth.submit_unavailable",
    "auth.submitted",
    "ehr.clinical_import",
    "ehr.connect_failed",
    "ehr.connected",
    "ehr.disconnected",
    "ehr.service_request_write_failed",
    "ehr.service_request_written",
    "ehr.token_refresh_failed",
    "ehr.token_refreshed",
    "family_link.upgrade_accepted",
    "family_link.upgrade_invited",
    "import.commit",
    "import.create",
    "import.map",
    "import.row.edit",
    ...
    "insurance_plan.unshared",
    "patient.create",
    "patient.delete",
    "patient.imported_from_ehr",
    "patient.scope_transferred",
    "patient.update",
    "provider.save",
    "provider.unsave",
    "referral.create",
